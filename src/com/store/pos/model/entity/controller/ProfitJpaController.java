...
public class ProfitJpaController implements Serializable {
    ...
    public ProfitJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Profit profit) {
    ...
    public void edit(Profit profit) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public Profit findProfit(Long id) {
        EntityManager em = getEntityManager();
        try {
